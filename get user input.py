...
originalImage=cv2.imread(input("Please enter original leaf "))
imageCheck=cv2.imread(input("Please enter leaf wich you like to check "))
...
if detectColorChanges(removeNoiseC)or detectMutance(removeNoiseOriginal,removeNoiseC):
    ...
    print("Leaf has not infected by diseas")
